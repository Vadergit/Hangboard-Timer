...
void rotary_loop()
{
  ...
  tft.drawBitmap(TFTWITH/2 - 36/2, TFTHEIGHT/2 - 48, epd_bitmap_Palm, 36, 48, TFT_WHITE);
  tft.drawBitmap(TFTWITH/2 - ((2 * 36) - 4)/2, TFTHEIGHT/2 - 48, epd_bitmap_Palml, 36, 48, TFT_WHITE);
   delay(1000);
  tft.drawBitmap(TFTWITH/2 - 36/2, TFTHEIGHT/2 - 48, epd_bitmap_Mittel, 36, 48, TFT_WHITE);
  tft.drawBitmap(TFTWITH/2 - ((2 * 36) - 4)/2, TFTHEIGHT/2 - 48, epd_bitmap_Mittell, 36, 48, TFT_WHITE);
  delay(1000);
  tft.drawBitmap(TFTWITH/2 - 36/2, TFTHEIGHT/2 - 48, epd_bitmap_Mittel, 36, 48, TFT_BLACK);
  tft.drawBitmap(TFTWITH/2 - ((2 * 36) - 4)/2, TFTHEIGHT/2 - 48, epd_bitmap_Mittell, 36, 48, TFT_BLACK);
  delay(1000);
  tft.drawBitmap(TFTWITH/2 - 36/2, TFTHEIGHT/2 - 48, epd_bitmap_Mittel, 36, 48, TFT_WHITE);
  tft.drawBitmap(TFTWITH/2 - ((2 * 36) - 4)/2, TFTHEIGHT/2 - 48, epd_bitmap_Mittell, 36, 48, TFT_WHITE);
  delay(1000);
